...
export const locations = {
    ...
    locBarrenfront: {
        ...
        travel: [
            ...
            { verbs: ['east', 'inside', 'barre', 'enter'], action: { name: 'goTo', description: 'locBarrenroom' } },
    ...
    locBelowgrate: {
        ...
        travel: [
            ...
            { verbs: ['crawl', 'cobbl', 'inside', 'west'], action: { name: 'goTo', description: 'locCobble' } },
            { verbs: ['pit'], action: { name: 'goTo', description: 'locPittop' } },
        ...
        travel: [
            {
                ...
                action: {
                    ...
                    // condition: [not, plant, plantBellowing],
    ...
    locCobble: {
        ...
        travel: [
            ...
            { verbs: ['inside', 'dark', 'west', 'debri'], action: { name: 'goTo', description: 'locDebris' } },
            { verbs: ['pit'], action: { name: 'goTo', description: 'locPittop' } },
        ...
        travel: [
            { verbs: ['north', 'out'], action: { name: 'goTo', description: 'locDifferent2' } },
            {
                ...
                action: {
                    ...
                    // condition: [not, VEND, VEND_BLOCKS],
    ...
    locDebris: {
        ...
        travel: [
            ...
            { verbs: ['entra'], action: { name: 'goTo', description: 'locBelowgrate' } },
            { verbs: ['crawl', 'cobbl', 'passa', 'low', 'east'], action: { name: 'goTo', description: 'locCobble' } },
            { verbs: ['canyo', 'inside', 'upwar', 'west'], action: { name: 'goTo', description: 'locAwkward' } },
        ...
        travel: [
            { verbs: ['hall', 'east'], action: { name: 'goTo', description: 'locMisthall' } },
            {
                ...
                action: {
                    ...
                    // condition: [not, fissure, unbridged],
                },
            },
            {
                verbs: ['forwa'],
    ...
    locIncline: {
        ...
        conditions: { deep: true },
        travel: [
            { verbs: ['north', 'cavern', 'passa'], action: { name: 'goTo', description: 'locWaterfall' } },
        ...
        travel: [
            { verbs: ['stair', 'upwar', 'east'], action: { name: 'goTo', description: 'locMisthall' } },
            {
                ...
                action: {
                    ...
                    // condition: [not, snake, snakeBlocks],
    ...
    locLimestone: {
        ...
        travel: [
            ...
            { verbs: ['south', 'down', 'barre'], action: { name: 'goTo', description: 'locBarrenfront' } },
            { verbs: ['view'], action: { name: 'goTo', description: 'locBreathtaking' } },
        ]
    },
    locLongeast: {
    ...
    locMistwest: {
        ...
        conditions: { deep: true },
        travel: [
            { verbs: ['south', 'upwar', 'passa', 'climb'], action: { name: 'goTo', description: 'locAlike1' } },
  ...
  // wired-in assumption that the dragon corpse goes to locSecret5,
    ...
    locShellroom: {
        ...
        travel: [
            ...
            // { verbs: ['south], condition: [carry, clam], action: { name: 'speak', description: 'clamBlocker' } },
    ...
    locSlit: {
        ...
        travel: [
            ...
            { verbs: ['downs', 'bed', 'south', 'depre'], action: { name: 'goTo', description: 'locGrate' } },
    ...
    locSmallpit: {
        ...
        sound: 'streamGurgles',
        travel: [
            { verbs: ['climb', 'upwar', 'out'], action: { name: 'goTo', description: 'locSmallpitbrink' } },
    ...
    locSwchasm: {
        ...
        travel: [
            ...
            // { verbs: ['over'], condition: [not, chasm, trollBridge], action: { name: 'speak', description: 'bridgeGone' } },
            { verbs: ['over'], action: { name: 'special', description: 3 } },
            {
                verbs: ['jump'],
                action: {
                    name: 'goTo',
                    description: 'locNomake',
                    // condition: [not, chasm, trollBridge],
        ...
        travel: [
            { verbs: ['upwar', 'out'], action: { name: 'goTo', description: 'locWestend' } },
            {
                ...
                action: {
                    ...
                    // condition: [not, plant, plantGrown],
