...
export const actions = {
    ...
    tree: {
        message: 'The trees of the forest are large hardwood oak and maple, with an occasional grove of pine or spruce. There is quite a bit of under-wth, largely birch and ash saplings plus nondescript bushes ofious sorts. This time of year visibility is quite restricted by the leaves, but travel is quite easy if you detour around theuce and berry bushes.',
        verbs: ['tree', 'trees'],
        noaction: true,
    },
    unlock: {
